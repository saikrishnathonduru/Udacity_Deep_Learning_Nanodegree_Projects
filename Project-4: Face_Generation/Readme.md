...
```
git clone https://github.com/saikrishnathonduru/Udacity_Deep_Learning_Nanodegree_Projects/tree/master/Project-4:%20Face_Generation.git
cd Project-Face-Generation-Udacity

```
2. Now please open the file with filename: face_generation.ipynb
